...
const EndOfLevel = ({
  ...
  return (
      <div className={"jmc-end-of-level"}>
        <a ref={a => refLink = a} className={"visibility-hidden"} href={nextLevelLink}>Hide</a>
        <JMCSection>
          ...
          <div className="col-md-10">
            <div className="row justify-content-center">
              ...
              <div className="col-md-6 high-score">
                {/*<div className="test_box img-box">
                  <div className="jons">
                    <figure><img src={IMG} alt="#"/></figure>
                  </div>
                </div>*/}
                <div className="test_box text-box">
                  <h4 className={"mb-3"}>High Scores</h4>
                  <span className="small-bar mb-2"> </span>
                      ...
                      <div className="leader-wrap">
                        ...
                        <div className="leader-content">
                          ...
                          <div className="leader-score">
                            ...
                            <div className="leader-score_title">350</div>
                          </div>
                        </div>
                      </div>
                ...
                {/*<div style={{backgroundImage: `${IMG}`}} className="test_box">
                  <p>High Scores</p>
                  <p>1. AAA: 875</p>
                  <p>2. BBB: 434</p>
                  <p>3. CCC: 232</p>
